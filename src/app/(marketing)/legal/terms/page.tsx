        ...
        <div className="prose prose-sky max-w-none space-y-8 text-gray-700 leading-relaxed">
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>パーソナルカラー診断 AI ツール（無料試用 3 回 ＋ 有料ポイントパック）</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              ...
              <li>有料ポイントを跨デバイスで管理する場合、Google アカウントまたはメールアドレスによるサインインが必要です。</li>
          ...
          <section>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>150 ポイントパック ¥300（税込）</strong>：prompta.jp 上の全ツール・全プロンプトで共通利用可能な買い切り型のポイントパック。画像生成 1 回 = 5 ポイント、文字実行 1 回 = 1 ポイント消費。ポイント有効期限は購入から 12 ヶ月。
              </li>
              <li>決済は Stripe Inc. を経由して行われます。当サイトはポイントカード情報を保持しません。</li>
              <li>ポイントは購入時に登録されたメールアドレスに紐付けられます。同じメールアドレスでサインインまたは復元することで、複数デバイスから利用できます。</li>
              <li>
                <strong>返金ポリシー</strong>：デジタルコンテンツの性質上、購入後の自己都合による返金には対応いたしかねます。当サイトのシステム不具合により正常にポイントが付与されなかった場合は、お問い合わせ窓口にご連絡ください。
              </li>
