        ...
        <div className="prose prose-sky max-w-none text-gray-700 leading-relaxed">
          <dl className="divide-y divide-gray-200 border-t border-b border-gray-200">
            ...
            <Row
              ...
              valueHtml={
                <>
                  <strong>150 ポイントパック ¥300（税込）</strong>
                  <br />
                  prompta.jp 上の全ツール・全 180 プロンプトで共通利用可能な買い切り型ポイントパックです。画像生成は 1 回 5 ポイント、文字実行は 1 回 1 ポイント消費します。ポイント有効期限は購入から 12 ヶ月。
                </>
              }
            />
            ...
            <Row
              label="支払方法"
              value="ポイントカード（Visa / Mastercard / American Express / JCB）"
              hint="決済は Stripe Inc. を経由して行われます。当サイトはポイントカード情報を保持しません。"
            />
            <Row label="支払時期" value="注文確定時にお支払いが発生します。" />
            <Row
              label="役務（ポイント）の提供時期"
              value="決済完了後、即時にポイントを付与いたします。"
              hint="通常は数秒〜数十秒以内にご利用可能となります。万一ポイントが付与されない場合は、上記メールアドレスまでご連絡ください。"
            />
            <Row
              label="返品・キャンセル特約"
              valueHtml={
                <>
                  ...
                  <br />
                  ただし、当サイトのシステム不具合により正常にポイントが付与されなかった場合、または重大なサービス障害により役務の提供ができない場合は、上記メールアドレスへご連絡いただければ調査の上、返金または再付与にて対応いたします。
                </>
              }
            />
            <Row
