...
export default function PersonalColorAnalysisEnPage() {
  ...
  const appJsonLd = {
    ...
    offers: {
      ...
      price: '0',
      priceCurrency: 'JPY',
      description: 'Sign in for 15 free credits; ¥300 for a 150-credit pack',
    },
    aggregateRating: {
