...
const FAQ = [
  ...
  {
    q: '料金はどうなっていますか？',
    a: '初回ログインで 15 クレジット無料プレゼント（=画像生成 3 回 OR 文字実行 15 回）。それ以上は ¥300 / 150 クレジットパックを Stripe で購入できます。クレジットは「パーソナルカラー診断」を含む全ツール・全 180 プロンプトで共通利用可能。画像生成 1 回 = 5 クレジット消費、判定・診断（テキスト出力）= 1 クレジット消費。',
  },
  {
...
const TOOL_LD = {
  ...
  offers: {
    ...
    price: '0',
    priceCurrency: 'JPY',
    description: 'ログインで 15 クレジット無料 + ¥300/150 クレジットパック',
  },
