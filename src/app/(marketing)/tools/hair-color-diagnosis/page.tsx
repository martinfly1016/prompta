...
const FAQ = [
  ...
  {
    q: '料金はどうなっていますか？',
    a: '初回 Google ログインで 50 クレジット無料プレゼント（=画像生成 10 回 OR 文字実行 50 回）。それ以上は ¥300 / 150 クレジットパックを Stripe で購入できます。クレジットは「パーソナルカラー診断」を含む全ツール・全 180 プロンプトで共通利用可能。画像生成 1 回 = 5 クレジット消費、判定・診断（テキスト出力）= 1 クレジット消費。',
  },
  {
    q: '別の候補もシミュレーションできますか？',
    a: 'はい、5 候補それぞれに「この色を試す」ボタンがあります。タップするとその色で Before/After を再生成します。1 タップ＝ 5 クレジット消費です。',
  },
  {
    q: '写真の撮り方のコツは？',
...
const TOOL_LD = {
  ...
  offers: {
    ...
    price: '0',
    priceCurrency: 'JPY',
    description: 'ログインで 50 クレジット無料 + ¥300/150 クレジットパック',
  },
