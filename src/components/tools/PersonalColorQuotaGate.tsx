...
const STRINGS = {
  ja: {
    ...
    modalDescLogin: `初回ログインで ${WELCOME_CREDITS} ポイント無料プレゼント（=画像生成 3 回 OR 文字実行 15 回）。即時利用可能・別ツールでも共通でお使いいただけます。`,
    ...
    upsellBannerBody: 'ポイント切れの場合は ',
    upsellBannerLink: '150 ポイント ¥300 パック',
