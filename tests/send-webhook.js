...
//   WEBHOOK_TEST_PAYMENT_STATUS=unpaid    — set payment_status to non-paid value
//                                            (tests the payment_status guard)
...
const paymentStatus = process.env.WEBHOOK_TEST_PAYMENT_STATUS || 'paid'
const session = {
  id: sessionId,
